...
class AdminContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'simplygdb', 'user' => 'root', 'password' => '', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), ['enum' => 'string']);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $d = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => 'C:\\wamp64\\www\\simplyG\\modules\\productcomments\\src\\Entity']);
        $d->addExcludePaths([0 => 'C:\\wamp64\\www\\simplyG\\modules\\productcomments\\src\\Entity/index.php']);
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => 'C:\\wamp64\\www\\simplyG\\modules\\ps_checkout\\src\\Entity']);
        $e->addExcludePaths([0 => 'C:\\wamp64\\www\\simplyG\\modules\\ps_checkout\\src\\Entity/index.php']);

        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => 'C:\\wamp64\\www\\simplyG\\src\\PrestaShopBundle\\Entity']), 'PrestaShop');
        ...
        $a->setProxyDir('C:\\wamp64\\www\\simplyG/var/cache/prod\\/doctrine/orm/Proxies');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_49c48c259a499a71c42d9b8583bd150fb5a6320e4a0ce988a272fe32fc8c7b01');
    ...
    {
        return $this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, 'C:\\wamp64\\www\\simplyG/var/cache/prod\\/localization');
    }
    ...
    {
        return $this->services['ps_checkout.cache.directory'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('1.7.7.6', 'C:\\wamp64\\www\\simplyG', false);
    }
    ...
    {
        return $this->services['ps_checkout.logger.directory'] = new \PrestaShop\Module\PrestashopCheckout\Logger\LoggerDirectory('1.7.7.6', 'C:\\wamp64\\www\\simplyG');
    }
    ...
    /**
     * Gets the private 'PrestaShop\Module\PsxMarketingWithGoogle\Builder\CarrierBuilder' shared service.
     *
    ...
    /**
     * Gets the private 'PrestaShop\Module\PsxMarketingWithGoogle\Database\Installer' shared service.
     *
    ...
    /**
     * Gets the private 'PrestaShop\Module\PsxMarketingWithGoogle\Database\Uninstaller' shared service.
     *
    ...
    /**
     * Gets the private 'PrestaShop\Module\PsxMarketingWithGoogle\Provider\CarrierDataProvider' shared service.
     *
    ...
    /**
     * Gets the private 'PrestaShop\Module\PsxMarketingWithGoogle\Provider\GoogleTagProvider' shared service.
     *
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.root_dir' => 'C:\\wamp64\\www\\simplyG/app',
            'kernel.project_dir' => 'C:\\wamp64\\www\\simplyG',
            'kernel.name' => 'app',
            'kernel.debug' => false,
            'kernel.environment' => 'prod',
            'kernel.cache_dir' => 'C:\\wamp64\\www\\simplyG/var/cache/prod\\',
            ...
            'ps_cache_dir' => 'C:\\wamp64\\www\\simplyG/var/cache/prod\\',
            ...
            'doctrine.orm.proxy_dir' => 'C:\\wamp64\\www\\simplyG/var/cache/prod\\/doctrine/orm/Proxies',
